...
@IBDesignable public class SVGPlayButton: UIButton {
    ...
    @IBInspectable public var progressTrackColor: UIColor = kDefaultProgressTrackColor
    
    @IBInspectable public var playColor: UIColor = kDefaultPlayColor
    
    @IBInspectable public var pauseColor: UIColor = kDefaultPauseColor
